...
export default function IntroSlide({ isActive, onYesClick, slideNumber, totalSlides }: IntroSlideProps) {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center px-4">
      ...
      >
        ...
        >
          So... I made this because I was bored
        </motion.p>
        ...
        >
          Okay fine, I was thinking about you. Wanna see what I came up with? 😏
        </motion.p>
