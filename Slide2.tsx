...
export default function Slide2({ isActive, onYesClick, slideNumber, totalSlides }: Slide2Props) {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center px-4">
      ...
      >
        ...
        >
          You made that day actually bearable. I thought I'd be sad but you made it... kinda fun? 🤔
        </motion.p>
