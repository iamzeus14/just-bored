...
export default function Slide3({ isActive, onYesClick, slideNumber, totalSlides }: Slide3Props) {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center px-4">
      ...
      >
        ...
        >
          Best part of school? Not the classes...
        </motion.p>
        ...
        >
          Walking aimlessly in corridors, pretending we had somewhere to be. Good times, good times 😄
        </motion.p>
