...
export default function Slide4({ isActive, onYesClick, slideNumber, totalSlides }: Slide4Props) {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center px-4">
      ...
      >
        <div className="relative w-20 h-20">
          <motion.div
            ...
            animate={{ boxShadow: ["0 0 40px rgba(253, 224, 71, 0.5)", "0 0 80px rgba(253, 224, 71, 0.8)", "0 0 40px rgba(253, 224, 71, 0.5)"] }}
      ...
      >
        ...
        >
          Phone battery: 1%. Us: Still talking...
        </motion.p>
        ...
        >
          I still don't know what we talked about for hours. Probably nonsense. But I miss that nonsense 😅
        </motion.p>
